...
describe('WebSocket Connection Tests', () => {
  ...
  test('should reset input state to safe state when client disconnects', async () => {
    ...
    inputState.gyroscope = { ...inputState.gyroscope, pitch: 10, roll: -10, yaw: 5 };
    ...
    expect(inputState.gyroscope.pitch).toBe(10);
    ...
    expect(inputState.gyroscope).toEqual(safeState.gyroscope);
  });
});
